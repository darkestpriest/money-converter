 ...
 */
public interface ExchangeRaterApi <O extends ApiObject> {
     ...
     * @return
     */
    boolean isCurrencyPairAllowed(final CurrencyPair currencyPair) throws MoneyExchangeRaterException;
     ...
     * @return
     */
    O getApiObject(final CurrencyPair currencyPair) throws MoneyExchangeRaterException;
